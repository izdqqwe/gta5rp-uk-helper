...
git add index.html law-engine.js pk-engine.js adv-engine.js p1-engine.js fib-engine.js np-engine.js guides-engine.js guides-embed.js laws-viewer.js laws-embed.js data/pk_articles.json data/adv_articles.json data/p1_articles.json data/fib_articles.json data/np_articles.json data/guides.json data/laws open.bat README.md .gitignore .nojekyll publish-github.bat
